  ...
  <g transform="translate(50, 35)">
    ...
    <g transform="translate(1550, 24)">
      ...
      <g transform="translate(670, 0)">
        ...
        <text x="14" y="52" fill="#FAF5FF" font-size="21" font-weight="800">22 <tspan fill="#A855F7" font-size="12" font-weight="600">Governorates</tspan> <tspan fill="#64748B" font-size="11">(5 Regions)</tspan></text>
      </g>
    ...
    <g transform="translate(18, 75)">
      ...
      <g transform="translate(14, 40)">
        ...
        <g transform="translate(10, 56)">
          ...
          <text x="0" y="30" fill="#94A3B8" font-size="10">gross_sales • discount_pct • net_sales • cost • status (Completed / Returned / Cancelled)</text>
        </g>
      </g>
      ...
      <g transform="translate(14, 150)">
        ...
        <g transform="translate(10, 32)">
          ...
          <text x="254" y="13" fill="#E2E8F0" font-size="9" text-anchor="middle">🏛️ governorate (22 Governorates)</text>
        </g>
        <g transform="translate(10, 56)">
          <text x="0" y="14" fill="#94A3B8" font-size="10">name_ar (مريم إبراهيم) • name_en • email • segment • signup_date</text>
          <text x="0" y="30" fill="#64748B" font-size="9.5">Unformatted phones (+2010 vs 010) &amp; trailing whitespace</text>
        </g>
      </g>
      ...
      <g transform="translate(14, 255)">
        ...
        <g transform="translate(10, 56)">
          ...
          <text x="0" y="30" fill="#64748B" font-size="9.5">Formulation origin: Local Egyptian Formula vs European Import</text>
        </g>
      </g>
    ...
    <g transform="translate(18, 580)">
      ...
      <g transform="translate(14, 40)">
        ...
        <g transform="translate(10, 36)">
          ...
          <text x="261" y="17" fill="#FECDD3" font-size="9.5" font-weight="700" text-anchor="middle">Damaged</text>
    ...
    <g transform="translate(16, 205)">
      ...
      <g transform="translate(0, 28)">
        ...
        <g transform="translate(12, 36)">
          ...
          <text x="34" y="12" fill="#94A3B8" font-size="8.5" text-anchor="middle">19 Raw Columns</text>
        ...
        <text x="12" y="74" fill="#64748B" font-size="9.5">Contains unvalidated raw orders (Negative values, unmapped keys)</text>
        ...
        <g transform="translate(12, 131)">
          <rect width="68" height="16" rx="4" fill="#1E293B"/>
          <text x="34" y="12" fill="#94A3B8" font-size="8.5" text-anchor="middle">11 Raw Columns</text>
          <rect x="74" y="0" width="95" height="16" rx="4" fill="#1E293B"/>
    ...
    <g transform="translate(18, 75)">
      ...
      <g transform="translate(0, 390)">
        ...
        <g transform="translate(14, 34)">
          ...
          <rect x="172" y="0" width="145" height="28" rx="6" fill="#064E3B" stroke="#059669" stroke-width="0.8"/>
          <text x="8" y="18" fill="#A7F3D0" font-size="10">Completed / Returned / Cancelled</text>
        </g>
    ...
    <g transform="translate(18, 710)">
      ...
      <g transform="translate(14, 20)">
        ...
        <g transform="translate(0, 36)">
          ...
          <text x="12" y="110" fill="#94A3B8" font-size="10">Clean 11-digit mobile, lowercase emails, canonical governorates</text>
  ...
  <g transform="translate(1290, 175)" filter="url(#shadowLg)">
    ...
    <g transform="translate(18, 75)">
      ...
      <g transform="translate(16, 42)">
        ...
        <text x="10" y="32" fill="#94A3B8" font-size="9">Open + Recv - Sold - Damaged = Close</text>
      ...
      <g transform="translate(16, 20)">
        ...
        <g transform="translate(0, 48)">
          ...
          <g transform="translate(12, 34)">
            ...
            <text x="8" y="16" fill="#FECDD3" font-size="9.5">🔗 Orphan Customer FK: 2,840</text>
        ...
        <g transform="translate(0, 245)">
          ...
          <g transform="translate(12, 34)">
            ...
            <rect x="165" y="0" width="160" height="24" rx="4" fill="#200B11" stroke="#BE123C" stroke-width="0.8"/>
            <text x="8" y="16" fill="#FECDD3" font-size="9.5">🏛️ Unmapped Governorate: 95</text>
    ...
    <g transform="translate(20, 75)">
      ...
      <g transform="translate(275, 450)">
        ...
        <g transform="translate(10, 30)">
          ...
          <text x="0" y="70" fill="#34D399" font-size="8.5">list_price_egp • standard_cost_egp • margin_pct</text>
        </g>
      </g>
      ...
      <g transform="translate(0, 565)">
        ...
        <g transform="translate(14, 38)">
          ...
          <text x="10" y="18" fill="#A7F3D0" font-size="10.5" font-weight="700">dim_geography (22 Governorates)</text>
        ...
        <g transform="translate(0, 44)">
          ...
          <g transform="translate(0, 125)">
            ...
            <g transform="translate(10, 30)">
              ...
              <text x="65" y="44" fill="#94A3B8" font-size="7.5" text-anchor="middle">22 Governorates</text>
          ...
          <g transform="translate(0, 500)">
            ...
            <g transform="translate(10, 30)">
              ...
              <text x="82" y="36" fill="#FBBF24" font-size="7.5" text-anchor="middle">Cairo Flagship: 108% (Achieved)</text>
              <text x="82" y="50" fill="#F43F5E" font-size="7.5" text-anchor="middle">Alex Mall: 91% (Below Target)</text>
